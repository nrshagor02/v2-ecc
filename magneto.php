            ...
            <div class="data-management-container-left ">
                <div class="amazon-hero-text">
                    <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1100">
                        <h4>Grow profits quickly on Magneto E-commerce</h4>
                        <h2>Take Your Business to the Next Level with Magneto E-commerce</h2>
                    </div>
                    <p>Magneto E-commerce, Aliquam erat volutpat. Etiam velit ipsum, placerat id faucibus id, mattis faucibus dui. </p>
...
<div class="mobile-dm-container data-management-bg-color mobile-show tablet-hide">
        <h3>Grow profits quickly on Magneto E-commerce</h3>
        <h1>Take Your Business to the Next Level with Magneto E-commerce</h1>
        <p class="m-dm-hero-text">Magneto E-commerce, or pay-per-click, is one of the online advertising 
    ...
    <div class="amazon-container driving-bg mobile-hide tablet-hide">
        <div class="amazon-drive-row">
            ...
            <div class="driving-right">
                <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1100">
                    <h4>Why Choose Us</h4>
                    <h2>In your Magneto E-commerce growth strategy, 
    ...
    <div class="amazon-container mobile-hide tablet-hide">
        <div class="amazon-row">
            <div class="amazon-store-left">
                <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1100">
                    <h4>Services for Magneto E-commerce</h4>
            ...
            <div class="ecom-slider">
                <div class="owl-slider">
                    <div id="m-choose-dm" class="owl-carousel ecommerce-slider brand-owl dm-carousel-mb">
                        ...
                        For Your Magneto E-commerce Business</h1>
                        ...
                        <div class="item">
                            <h3>In your Magneto E-commerce growth strategy</h3>
