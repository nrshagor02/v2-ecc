...
<section>
<div class="customer-support-container-hero customer-support-bg-color mobile-hide tablet-hide">
        <div class="amazon-row-hero">
            ...
            <div class="data-management-container-right">
             <img src="images/datamanagement/customerSupport.png" alt="" class="amazon-hero-bg-image">
            </div>
        </div>
    </div>
            <!--mobile fahim -->
<div class="mobile-dm-container customer-support-bg-color mobile-show tablet-hide">
        ...
        <p class="m-dm-hero-text">Amazon, the world’s largest retailer, manages a massive amount of
                        data related to its operations, customers, and supply chain. </p>
        <img src="images/datamanagement/customerSupport.png" class="mobile-hero-bg" alt="">
...
<!--mobile fahim -->
<!-- tablet---fahim -->
<div class="tablet-dm-container customer-support-bg-color mobile-hide tablet-show">
        <h3>Grow profits quickly on Amazon</h3>
        <h1>A-Z Data Management <br> for Amazon Stores</h1>
        <p class="m-dm-hero-text">Amazon, the world’s largest retailer, manages a massive amount of
                        data related to its operations, customers, and supply chain. </p>
        <div class="t-dm-amazon-content">
            ...
            <div class="t-dm-hero-right">
                <img src="images/datamanagement/customerSupport.png" alt="tablet">
            </div>
</div>
    ...
    <div class="amazon-container mobile-hide tablet-hide">
        <div class="amazon-row">
            ...
            <div class="amazon-store-right">
                <img class="service-images" src="images/ppc/amazon-competitor.png" alt="">
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="amazon-container mobile-hide tablet-hide">
        <div class="amazon-row">
            ...
            <div class="amazon-store-right">
                <img class="service-images" src="images/ppc/amazon-keyword.png" alt="">
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="amazon-container mobile-hide tablet-hide">
        <div class="amazon-row amazon-data-margin">
            ...
            <div class="amazon-store-right">
                <img class="service-images" src="images/ppc/amazon-adjusting.png" alt="">
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="amazon-container mobile-hide tablet-hide">
        <div class="amazon-row amazon-data-margin">
            ...
            <div class="amazon-store-right">
                <img class="service-images" src="images/ppc/amazon-analysis.png" alt="">
            </div>
        </div>
    </div>
</section>
