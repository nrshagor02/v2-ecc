            ...
            <div class="data-management-container-left ">
                <div class="amazon-hero-text">
                    <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1100">
                        <h4>Grow profits quickly on UX Website Redesign</h4>
                        <h2>Take Your Business to the Next Level with UX Website Redesign</h2>
                    </div>
                    <p>UX Website Redesign, Aliquam erat volutpat. Etiam velit ipsum, placerat id faucibus id, mattis faucibus dui.  </p>
...
<div class="mobile-dm-container data-management-bg-color mobile-show tablet-hide">
        <h3>Grow profits quickly on UX Website Redesign</h3>
        <h1>Take Your Business to the Next Level with UX Website Redesign</h1>
        <p class="m-dm-hero-text">UX Website Redesign, Aliquam erat volutpat. Etiam velit ipsum, placerat id faucibus id, mattis faucibus dui.  </p>
    ...
    <div class="growth-container driving-bg mobile-hide tablet-hide">
        <div class="amazon-drive-row">
            ...
            <div class="driving-right">
                <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1100">
                    <h4>Why Choose Us</h4>
                    <h2>In your UX Website Redesign growth strategy, 
    ...
    <div class="amazon-container mobile-hide tablet-hide">
        <div class="amazon-row">
            <div class="amazon-store-left">
                <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1100">
                    <h4>Services for UX Website Redesign</h4>
            ...
            <div class="ecom-slider">
                <div class="owl-slider">
                    <div id="m-choose-dm" class="owl-carousel ecommerce-slider brand-owl dm-carousel-mb">
                        ...
                        For Your UX Website Redesign</h1>
                        ...
                        <div class="item">
                            <h3>In your UX Website Redesign growth </h3>
